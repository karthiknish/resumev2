...
const benefits: Benefit[] = [
  {
    ...
    description:
      "You work with person doing work—no agency overheads. Every hour invested lands directly in design, engineering, and launch momentum.",
    delay: 0.2,
  },
  {
...
const WhyFreelancerSection: React.FC = () => {
  const cardVariants = {
...
export default WhyFreelancerSection;
