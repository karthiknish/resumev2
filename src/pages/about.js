            ...
            <Card className="border-none bg-black/60 backdrop-blur-sm">
              ...
              <CardContent className="space-y-6">
                <p className="text-xl text-gray-300">
                  Hey! I&apos;m Karthik Nishanth, a Full Stack Developer based
                  in Liverpool with a passion for building elegant, efficient,
            ...
            <Card className="border-none bg-black/60 backdrop-blur-sm">
              ...
              <CardContent className="space-y-4">
                <p className="text-xl text-gray-300">
                  ...
                  established businesses, and everything in between, helping
                  them achieve their digital transformation goals.
                </p>
                <p className="text-xl text-gray-300">
