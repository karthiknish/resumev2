// src/pages/api/ai/agent-generate-outline.js
...
async function fetchUrlContent(url) {
  try {
    ...
    console.error(`[Agent Outline] Error fetching URL:`, error.message);
    throw error;
  }
}
  ...
  try {
    ...
    if (url?.trim()) {
      try {
        ...
        console.error('[Agent Outline] URL fetch failed, proceeding with context only:', urlError.message);
      }
    }
