  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 relative flex items-center justify-center overflow-hidden" style={{ fontFamily: "Inter, sans-serif" }}>
        ...
        >
          <div className="bg-white/90 backdrop-blur-sm border-2 border-orange-200 rounded-3xl shadow-2xl p-8">
            <div className="text-center mb-8">
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                transition={{ duration: 0.5, delay: 0.2 }}
                className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-orange-100 to-yellow-100 border border-orange-200 rounded-full text-orange-700 text-sm font-semibold mb-6 shadow-lg"
              >
                <motion.span
              ...
              <p className="text-gray-600 text-lg font-medium">Don't worry, we'll help you reset it</p>
            </div>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white py-4 rounded-2xl font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                >
                  {isLoading ? (
                    <>
