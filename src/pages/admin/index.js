    ...
    return (
      <PageTransition>
        <div className="admin-dashboard min-h-screen bg-background text-foreground">
          ...
          <PageContainer className="px-4 pt-24 md:pt-28 lg:pt-34 text-foreground md:px-8 lg:px-10">
            <SlideInLeft delay={0.2}>
              <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                  <h1 className="text-3xl font-heading font-bold leading-tight tracking-tight text-foreground sm:text-4xl">
                    Admin Dashboard
                  </h1>
            ...
            <FadeIn delay={0.3}>
              <Separator className="my-5 h-[2px] rounded-full bg-border" />
            </FadeIn>
            ...
            >
              <SlideUp delay={0.4}>
                ...
                <TabsList className="hidden w-full snap-x snap-mandatory justify-center gap-2 overflow-x-auto rounded-2xl border border-border bg-card py-3 shadow-sm scrollbar-thin md:py-4 lg:my-5 lg:flex">
                ...
                <div className="mb-5 block lg:hidden">
                  <Select value={activeTab} onValueChange={setActiveTab}>
                    <SelectTrigger className="w-full rounded-2xl border border-border bg-card px-5 py-3 text-base font-semibold text-foreground shadow-sm">
                      ...
                      {adminTabs.map((tab) => (
                        ...
                        >
                          <div className="flex items-center">
                            ...
                            {tab.value === "contacts" &&
                              unreadContactsCount > 0 && (
                                <span className="ml-3 inline-flex items-center justify-center rounded-full bg-destructive/10 px-2 py-1 text-xs font-bold text-destructive">
                                  {unreadContactsCount > 9
                                    ? "9+"
                                    : unreadContactsCount}
                                </span>
