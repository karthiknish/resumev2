      ...
      <PageContainer>
        <div className="min-h-screen overflow-hidden">
          <section className="relative overflow-hidden">
            ...
            <div className="absolute inset-0 -z-20 bg-background/85 backdrop-blur-sm" />
            ...
            <div className="relative max-w-5xl mx-auto px-6 sm:px-10 md:px-12 pt-24 pb-20 md:pt-32 md:pb-24 text-center">
              <motion.div
                ...
                className="inline-flex items-center gap-3 px-5 py-2.5 bg-card border border-border rounded-full text-muted-foreground text-sm font-semibold mb-6 shadow-sm"
              >
              ...
              <motion.h1
                ...
                className="font-heading text-4xl sm:text-5xl md:text-6xl leading-tight text-foreground mb-6"
              >
              ...
              <FadeIn delay={0.1}>
                ...
                <div className="bg-card border border-border rounded-3xl shadow-sm overflow-hidden">
                  <Tabs defaultValue="message" className="w-full">
                    <div className="flex justify-center border-b border-border bg-muted/50 p-2">
                      <TabsList className="bg-muted/80 p-1">
                        <TabsTrigger 
                          value="message" 
                          className="flex items-center gap-2 data-[state=active]:bg-background data-[state=active]:text-brand-secondary px-6 py-2.5 rounded-lg transition-all"
                        >
                    ...
                    <div className="p-6 sm:p-10">
                      ...
                      <TabsContent value="meeting" className="mt-0 outline-none">
                        <div className="text-center mb-8">
                          <h3 className="font-heading text-2xl text-foreground mb-2">Book a 15-minute consultation</h3>
                          <p className="text-muted-foreground">Pick a time that works for you. We'll talk through your goals and timelines.</p>
                        </div>
                        <div className="min-h-[500px] bg-muted border border-border rounded-2xl flex items-center justify-center overflow-hidden">
                          <Cal
                            namespace="15min"
          ...
          <section className="relative overflow-hidden py-20 md:py-24 bg-gradient-to-br from-info via-brand-secondary to-primary">
            <div className="pointer-events-none absolute inset-0 -z-20 bg-[radial-gradient(circle_at_top,hsl(var(--primary-foreground)_/_0.28),transparent_55%)]" aria-hidden />
            <div className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_bottom,hsl(var(--brand-secondary)_/_0.35),transparent_70%)]" aria-hidden />

            <div className="relative max-w-5xl mx-auto px-6 sm:px-10 md:px-12 text-center text-primary-foreground">
              <motion.h2
              ...
              <motion.p
                ...
                className="mt-6 text-base text-primary-foreground/90 leading-relaxed max-w-2xl mx-auto"
              >
              ...
              >
                ...
                <a
                  href="/services"
                  className="inline-flex items-center justify-center gap-2 rounded-2xl border border-primary-foreground/50 bg-primary-foreground/10 px-6 py-3 font-semibold text-primary-foreground transition hover:bg-primary-foreground/20"
                >
                  Explore services
                </a>
              </motion.div>
              ...
              <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6">
                {[
                  ...
                  <motion.div
                    ...
                    className="rounded-2xl border border-primary-foreground/40 bg-primary-foreground/15 p-5 text-left"
                  >
