...
const service = {
  icon: <FaGlobe className="text-5xl mb-4" style={{ color: "#2DD4BF" }} />,
      ...
      <PageContainer>
        <div className="min-h-screen p-8 md:p-16 max-w-4xl mx-auto">
          <FadeIn>
            ...
            <ul className="space-y-3 mb-12">
              {service.features.map((feature, idx) => (
                <li key={idx} className="flex items-start">
                  <div className="bg-teal-500 p-1 rounded-full mr-3 mt-1 flex-shrink-0">
                    <svg
            ...
            <h2 className="text-3xl font-semibold text-teal-400 mt-12 mb-4">
              The Challenge
            </h2>
            <p className="text-gray-300 mb-8 text-lg leading-relaxed">
            ...
            <div className="text-center mt-16 p-8 bg-gradient-to-r from-teal-900/30 to-cyan-900/30 rounded-lg">
              ...
              <Link
                ...
                className="inline-block px-8 py-3 bg-teal-500 hover:bg-teal-600 text-white font-semibold rounded-md transition-colors mr-4"
              >
