  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Set a new password for your Karthik Nishanth account. Secure your account with a new password."
        />
        <meta name="robots" content="noindex, nofollow" />

        {/* Open Graph */}
        <meta property="og:title" content="Reset Password | Karthik Nishanth" />
        <meta
          property="og:description"
          content="Set a new password for your Karthik Nishanth account. Secure your account with a new password."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://karthiknish.com/reset-password" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="Reset Password | Karthik Nishanth" />
        <meta
          name="twitter:description"
          content="Set a new password for your Karthik Nishanth account."
        />
